package com.aslanovaslan.mytokapp
...
import com.aslanovaslan.mytokapp.helpers.Board
import com.aslanovaslan.mytokapp.helpers.Cell
        ...
        for (i in board.board.indices) {
            for (j in board.board.indices) {
                when (board.board[i][j]) {
                    Board.PLAYER -> {
                        boardCells[i][j]?.setImageResource(R.drawable.ciricle)
